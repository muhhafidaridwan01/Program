from tkinter import Frame, Label, Entry, Button, PhotoImage, YES, BOTH, END, Tk, W
...
class FrmCelsius:
    ...
    def aturKomponen(self):
        ...
        Label(mainFrame, text='Celsius:').grid(row=0, column=0,
...
if __name__ == '__main__':
    root = Tk()  
    aplikasi = FrmCelsius(root, "Celsius-Qu")
    root.geometry("250x190")
    root.resizable(False, False)

    # ICON
    image_icon = PhotoImage(file="f_iconconvertsuhu.png")
